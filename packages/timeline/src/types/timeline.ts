...
export type TimelineStoreModifiers = {
  ...
  setHoveredSegment: (params?: { segment?: TimelineSegment; area?: SegmentArea }) => void
  setEditedSegment: ({ segment, status }: { segment?: TimelineSegment; status?: SegmentEditionStatus }) => void
  setSelectedSegment: (params?: { segment?: TimelineSegment; isSelected?: boolean; onlyOneSelectedAtOnce?: boolean }) => void
  handleSegmentEvent: ({ eventType, segment }: { eventType: SegmentPointerEvent; segment: TimelineSegment }) => SegmentEventCallbackHandler
  ...
  createTrack: (params?: CreateTrackParams) => number
  createClip: (params?: CreateClipParams) => Promise<TimelineSegment>
  ...
  assignTrack: ({ segment, track, triggerChange }: { segment: TimelineSegment; track: number; triggerChange?: boolean }) => Promise<void>
  addSegment: ({ segment, startTimeInMs, track }: { segment: TimelineSegment; startTimeInMs?: number; track?: number }) => Promise<void>
